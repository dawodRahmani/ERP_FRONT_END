...
store static data in /data folder, do not use indexedDb.
...
when you are working in a page, for each page, create a folder and save the main file there and compoenents of that file in that folder in /components folder.
