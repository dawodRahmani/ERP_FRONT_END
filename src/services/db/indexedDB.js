...
const DB_VERSION = 35; // Added payrollDistributions store
...
export const initDB = async () => {
  return openDB(DB_NAME, DB_VERSION, {
    upgrade(db, oldVersion, newVersion, transaction) {
      ...
      // Employee Position History store - tracks all positions held by an employee
      if (!db.objectStoreNames.contains("employeePositionHistory")) {
        const positionHistoryStore = db.createObjectStore(
        ...
        positionHistoryStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        positionHistoryStore.createIndex("position", "position", {
          unique: false,
        });
        positionHistoryStore.createIndex("department", "department", {
          unique: false,
        });
        positionHistoryStore.createIndex("project", "project", {
          unique: false,
        });
        positionHistoryStore.createIndex("startDate", "startDate", {
          unique: false,
        });
        positionHistoryStore.createIndex("endDate", "endDate", {
          unique: false,
        });
        positionHistoryStore.createIndex("isCurrent", "isCurrent", {
          unique: false,
        });
        positionHistoryStore.createIndex("createdAt", "createdAt", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("attendance")) {
        ...
        attendanceStore.createIndex("employeeDate", ["employeeId", "date"], {
          unique: true,
        });
      }
      ...
      if (!db.objectStoreNames.contains("leaveRequests")) {
        ...
        leaveRequestStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        leaveRequestStore.createIndex("leaveTypeId", "leaveTypeId", {
          unique: false,
        });
        leaveRequestStore.createIndex("status", "status", { unique: false });
        leaveRequestStore.createIndex("startDate", "startDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("jobRequisitions")) {
        ...
        reqStore.createIndex("requisitionId", "requisitionId", {
          unique: true,
        });
      ...
      if (!db.objectStoreNames.contains("candidates")) {
        ...
        candidateStore.createIndex("requisitionId", "requisitionId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("interviews")) {
        ...
        interviewStore.createIndex("candidateId", "candidateId", {
          unique: false,
        });
        interviewStore.createIndex("requisitionId", "requisitionId", {
          unique: false,
        });
        interviewStore.createIndex("interviewerId", "interviewerId", {
          unique: false,
        });
        interviewStore.createIndex("scheduledDate", "scheduledDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("jobOffers")) {
        ...
        offerStore.createIndex("requisitionId", "requisitionId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("jobAnnouncements")) {
        ...
        announcementStore.createIndex("announcementId", "announcementId", {
          unique: true,
        });
        announcementStore.createIndex("requisitionId", "requisitionId", {
          unique: false,
        });
        announcementStore.createIndex("status", "status", { unique: false });
        announcementStore.createIndex("publishDate", "publishDate", {
          unique: false,
        });
        announcementStore.createIndex("closingDate", "closingDate", {
          unique: false,
        });
        announcementStore.createIndex("createdAt", "createdAt", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("contractTypes")) {
        ...
        contractTypeStore.createIndex("category", "category", {
          unique: false,
        }); // permanent, project, consultant
        contractTypeStore.createIndex("isActive", "isActive", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("employeeContracts")) {
        ...
        empContractStore.createIndex("contractNumber", "contractNumber", {
          unique: true,
        });
        empContractStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        empContractStore.createIndex("contractTypeId", "contractTypeId", {
          unique: false,
        });
        empContractStore.createIndex("projectId", "projectId", {
          unique: false,
        });
        empContractStore.createIndex("startDate", "startDate", {
          unique: false,
        });
        ...
        empContractStore.createIndex("createdAt", "createdAt", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("contractAmendments")) {
        ...
        amendmentStore.createIndex("amendmentNumber", "amendmentNumber", {
          unique: true,
        });
        amendmentStore.createIndex("contractId", "contractId", {
          unique: false,
        });
        amendmentStore.createIndex("amendmentType", "amendmentType", {
          unique: false,
        }); // extension, salary, position, termination
        amendmentStore.createIndex("effectiveDate", "effectiveDate", {
          unique: false,
        });
        amendmentStore.createIndex("status", "status", { unique: false });
        amendmentStore.createIndex("approvedBy", "approvedBy", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("orientationChecklists")) {
        ...
        orientationStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        orientationStore.createIndex("status", "status", { unique: false }); // pending, in_progress, completed
        orientationStore.createIndex("startDate", "startDate", {
          unique: false,
        });
        orientationStore.createIndex("completionDate", "completionDate", {
          unique: false,
        });
        orientationStore.createIndex("conductedBy", "conductedBy", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("orientationItems")) {
        ...
        orientationItemStore.createIndex("checklistId", "checklistId", {
          unique: false,
        });
        orientationItemStore.createIndex("itemName", "itemName", {
          unique: false,
        });
        orientationItemStore.createIndex("category", "category", {
          unique: false,
        }); // policies, systems, team, security
        orientationItemStore.createIndex("isCompleted", "isCompleted", {
          unique: false,
        });
        orientationItemStore.createIndex("completedDate", "completedDate", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("probationRecords")) {
        ...
        probationStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        probationStore.createIndex("contractId", "contractId", {
          unique: false,
        });
        ...
        probationStore.createIndex("durationMonths", "durationMonths", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("probationEvaluations")) {
        ...
        probEvalStore.createIndex("probationId", "probationId", {
          unique: false,
        });
        probEvalStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        probEvalStore.createIndex("evaluatorId", "evaluatorId", {
          unique: false,
        });
        probEvalStore.createIndex("evaluationDate", "evaluationDate", {
          unique: false,
        });
        probEvalStore.createIndex("outcome", "outcome", { unique: false }); // confirm, extend, terminate
        probEvalStore.createIndex("overallRating", "overallRating", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("shortlistingScores")) {
        ...
        shortlistStore.createIndex("candidateId", "candidateId", {
          unique: false,
        });
        shortlistStore.createIndex("requisitionId", "requisitionId", {
          unique: false,
        });
        shortlistStore.createIndex("criteriaName", "criteriaName", {
          unique: false,
        });
        shortlistStore.createIndex("weight", "weight", { unique: false });
        shortlistStore.createIndex("score", "score", { unique: false });
        shortlistStore.createIndex("evaluatorId", "evaluatorId", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("allowanceTypes")) {
        ...
        allowanceTypeStore.createIndex("category", "category", {
          unique: false,
        }); // communication, transport, mahram, housing
        allowanceTypeStore.createIndex("isTaxable", "isTaxable", {
          unique: false,
        });
        allowanceTypeStore.createIndex("isActive", "isActive", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("employeeAllowances")) {
        ...
        empAllowanceStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        empAllowanceStore.createIndex("allowanceTypeId", "allowanceTypeId", {
          unique: false,
        });
        empAllowanceStore.createIndex("amount", "amount", { unique: false });
        empAllowanceStore.createIndex("effectiveFrom", "effectiveFrom", {
          unique: false,
        });
        empAllowanceStore.createIndex("effectiveTo", "effectiveTo", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("salaryAdvances")) {
        ...
        advanceStore.createIndex("repaymentStatus", "repaymentStatus", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("leaveBalances")) {
        ...
        leaveBalStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        leaveBalStore.createIndex("leaveTypeId", "leaveTypeId", {
          unique: false,
        });
        ...
        leaveBalStore.createIndex("carriedForward", "carriedForward", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("leaveApprovals")) {
        ...
        leaveAppStore.createIndex("leaveRequestId", "leaveRequestId", {
          unique: false,
        });
        leaveAppStore.createIndex("approverId", "approverId", {
          unique: false,
        });
        leaveAppStore.createIndex("approvalLevel", "approvalLevel", {
          unique: false,
        });
        leaveAppStore.createIndex("status", "status", { unique: false });
        leaveAppStore.createIndex("approvalDate", "approvalDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("performanceAppraisals")) {
        ...
        appraisalStore.createIndex("appraisalId", "appraisalId", {
          unique: true,
        });
        appraisalStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        appraisalStore.createIndex("periodId", "periodId", { unique: false });
        appraisalStore.createIndex("evaluatorId", "evaluatorId", {
          unique: false,
        });
        appraisalStore.createIndex("status", "status", { unique: false }); // draft, self_assessment, supervisor_review, completed
        appraisalStore.createIndex("overallRating", "overallRating", {
          unique: false,
        });
        appraisalStore.createIndex("submissionDate", "submissionDate", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("appraisalScores")) {
        ...
        scoreStore.createIndex("supervisorScore", "supervisorScore", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("pipGoals")) {
        ...
        pipGoalStore.createIndex("goalDescription", "goalDescription", {
          unique: false,
        });
        pipGoalStore.createIndex("targetDate", "targetDate", { unique: false });
        pipGoalStore.createIndex("status", "status", { unique: false });
        pipGoalStore.createIndex("progressPercentage", "progressPercentage", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("pipProgressReviews")) {
        ...
        pipReviewStore.createIndex("reviewDate", "reviewDate", {
          unique: false,
        });
        pipReviewStore.createIndex("reviewerId", "reviewerId", {
          unique: false,
        });
        pipReviewStore.createIndex("overallProgress", "overallProgress", {
          unique: false,
        });
        pipReviewStore.createIndex("recommendation", "recommendation", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("trainingTypes")) {
        ...
        trainTypeStore.createIndex("requiresBond", "requiresBond", {
          unique: false,
        });
        trainTypeStore.createIndex("bondDurationMonths", "bondDurationMonths", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingPrograms")) {
        ...
        trainProgStore.createIndex("trainingTypeId", "trainingTypeId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingAttendance")) {
        ...
        trainAttendStore.createIndex("programId", "programId", {
          unique: false,
        });
        trainAttendStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        trainAttendStore.createIndex("attendanceStatus", "attendanceStatus", {
          unique: false,
        }); // registered, attended, completed, dropped
        trainAttendStore.createIndex("completionDate", "completionDate", {
          unique: false,
        });
        trainAttendStore.createIndex("certificateIssued", "certificateIssued", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingNeedsAssessments")) {
        ...
        tnaStore.createIndex("assessmentYear", "assessmentYear", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("tnaItems")) {
        ...
        tnaItemStore.createIndex("recommendedTraining", "recommendedTraining", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("idpGoals")) {
        ...
        idpGoalStore.createIndex("progressPercentage", "progressPercentage", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("conductAcknowledgments")) {
        ...
        conductStore.createIndex("documentType", "documentType", {
          unique: false,
        }); // code_of_conduct, hr_policy, confidentiality, data_protection
        conductStore.createIndex("acknowledgmentDate", "acknowledgmentDate", {
          unique: false,
        });
        conductStore.createIndex("version", "version", { unique: false });
        conductStore.createIndex("witnessedBy", "witnessedBy", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("pseaDeclarations")) {
        ...
        pseaStore.createIndex("declarationDate", "declarationDate", {
          unique: false,
        });
        pseaStore.createIndex("trainingCompleted", "trainingCompleted", {
          unique: false,
        });
        pseaStore.createIndex("trainingDate", "trainingDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("coiDeclarations")) {
        ...
        coiStore.createIndex("declarationDate", "declarationDate", {
          unique: false,
        });
        coiStore.createIndex("hasConflict", "hasConflict", { unique: false });
        coiStore.createIndex("resolutionStatus", "resolutionStatus", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("disciplinaryTypes")) {
        ...
        discTypeStore.createIndex("defaultAction", "defaultAction", {
          unique: false,
      ...
      if (!db.objectStoreNames.contains("disciplinaryActions")) {
        ...
        discActionStore.createIndex("caseNumber", "caseNumber", {
          unique: true,
        });
        discActionStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        discActionStore.createIndex(
          "disciplinaryTypeId",
          "disciplinaryTypeId",
          { unique: false }
        );
        discActionStore.createIndex("incidentDate", "incidentDate", {
          unique: false,
        });
        discActionStore.createIndex("reportedDate", "reportedDate", {
          unique: false,
        });
        discActionStore.createIndex("actionTaken", "actionTaken", {
          unique: false,
        });
        ...
        discActionStore.createIndex("witnessId", "witnessId", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("grievances")) {
        ...
        grievanceStore.createIndex("grievanceNumber", "grievanceNumber", {
          unique: true,
        });
        grievanceStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        grievanceStore.createIndex("grievanceTypeId", "grievanceTypeId", {
          unique: false,
        });
        grievanceStore.createIndex("submissionDate", "submissionDate", {
          unique: false,
        });
        ...
        grievanceStore.createIndex("isConfidential", "isConfidential", {
          unique: false,
        });
        grievanceStore.createIndex("assignedTo", "assignedTo", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("grievanceInvestigations")) {
        ...
        grievInvStore.createIndex("grievanceId", "grievanceId", {
          unique: false,
        });
        grievInvStore.createIndex("investigatorId", "investigatorId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("grievanceResolutions")) {
        ...
        grievResStore.createIndex("grievanceId", "grievanceId", {
          unique: false,
        });
        grievResStore.createIndex("resolutionDate", "resolutionDate", {
          unique: false,
        });
        grievResStore.createIndex("resolutionType", "resolutionType", {
          unique: false,
        }); // mediation, corrective_action, disciplinary, dismissed
        grievResStore.createIndex("resolvedBy", "resolvedBy", {
          unique: false,
        });
        grievResStore.createIndex("appealable", "appealable", {
          unique: false,
        });
        grievResStore.createIndex("appealDeadline", "appealDeadline", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("assetTypes")) {
        ...
        assetTypeStore.createIndex("requiresReturn", "requiresReturn", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("employeeAssets")) {
        ...
        empAssetStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        empAssetStore.createIndex("assetTypeId", "assetTypeId", {
          unique: false,
        });
        empAssetStore.createIndex("assignedDate", "assignedDate", {
          unique: false,
        });
        empAssetStore.createIndex("returnedDate", "returnedDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("idCards")) {
        ...
        idCardStore.createIndex("replacementFee", "replacementFee", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("separationTypes")) {
        ...
        sepTypeStore.createIndex("noticePeriodDays", "noticePeriodDays", {
          unique: false,
        });
        sepTypeStore.createIndex(
      ...
      if (!db.objectStoreNames.contains("separationRecords")) {
        ...
        separationStore.createIndex("separationNumber", "separationNumber", {
          unique: true,
        });
        separationStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        separationStore.createIndex("separationTypeId", "separationTypeId", {
          unique: false,
        });
        separationStore.createIndex("requestDate", "requestDate", {
          unique: false,
        });
        separationStore.createIndex("effectiveDate", "effectiveDate", {
          unique: false,
        });
        separationStore.createIndex("lastWorkingDay", "lastWorkingDay", {
          unique: false,
        });
        separationStore.createIndex("status", "status", { unique: false }); // pending, approved, rejected, in_clearance, completed
        separationStore.createIndex("approvedBy", "approvedBy", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("exitClearanceDepartments")) {
        const clearDeptStore = db.createObjectStore(
        ...
        clearDeptStore.createIndex("isRequired", "isRequired", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("exitClearances")) {
        ...
        exitClearStore.createIndex("separationId", "separationId", {
          unique: false,
        });
        exitClearStore.createIndex("departmentId", "departmentId", {
          unique: false,
        });
        exitClearStore.createIndex("clearedBy", "clearedBy", { unique: false });
        exitClearStore.createIndex("clearanceDate", "clearanceDate", {
          unique: false,
        });
        exitClearStore.createIndex("status", "status", { unique: false }); // pending, cleared, outstanding
        exitClearStore.createIndex("outstandingItems", "outstandingItems", {
          unique: false,
        });
        exitClearStore.createIndex("outstandingAmount", "outstandingAmount", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("exitInterviews")) {
        ...
        exitIntStore.createIndex("separationId", "separationId", {
          unique: false,
        });
        exitIntStore.createIndex("employeeId", "employeeId", { unique: false });
        exitIntStore.createIndex("interviewDate", "interviewDate", {
          unique: false,
        });
        exitIntStore.createIndex("interviewerId", "interviewerId", {
          unique: false,
        });
        exitIntStore.createIndex("reasonForLeaving", "reasonForLeaving", {
          unique: false,
        });
        exitIntStore.createIndex("wouldRecommend", "wouldRecommend", {
          unique: false,
        });
        exitIntStore.createIndex("wouldReturn", "wouldReturn", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("finalSettlements")) {
        ...
        settlementStore.createIndex("settlementNumber", "settlementNumber", {
          unique: true,
        });
        settlementStore.createIndex("separationId", "separationId", {
          unique: false,
        });
        settlementStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        settlementStore.createIndex("grossAmount", "grossAmount", {
          unique: false,
        });
        settlementStore.createIndex("deductions", "deductions", {
          unique: false,
        });
        settlementStore.createIndex("netAmount", "netAmount", {
          unique: false,
        });
        settlementStore.createIndex("status", "status", { unique: false }); // calculated, approved, paid
        settlementStore.createIndex("paymentDate", "paymentDate", {
          unique: false,
        });
        settlementStore.createIndex("approvedBy", "approvedBy", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("workCertificates")) {
        ...
        certStore.createIndex("separationId", "separationId", {
          unique: false,
        });
        certStore.createIndex("issueDate", "issueDate", { unique: false });
        certStore.createIndex("issuedBy", "issuedBy", { unique: false });
        certStore.createIndex("certificateType", "certificateType", {
          unique: false,
        }); // experience, service, employment
      }
      ...
      if (!db.objectStoreNames.contains("travelRequests")) {
        ...
        travelStore.createIndex("requestNumber", "requestNumber", {
          unique: true,
        });
        travelStore.createIndex("employeeId", "employeeId", { unique: false });
        travelStore.createIndex("projectId", "projectId", { unique: false });
        travelStore.createIndex("destination", "destination", {
          unique: false,
        });
        travelStore.createIndex("departureDate", "departureDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("travelApprovals")) {
        ...
        travelAppStore.createIndex("travelRequestId", "travelRequestId", {
          unique: false,
        });
        travelAppStore.createIndex("approverId", "approverId", {
          unique: false,
        });
        travelAppStore.createIndex("approvalLevel", "approvalLevel", {
          unique: false,
        });
        travelAppStore.createIndex("status", "status", { unique: false });
        travelAppStore.createIndex("approvalDate", "approvalDate", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("dsaRates")) {
        ...
        dsaRateStore.createIndex("locationType", "locationType", {
          unique: false,
        }); // domestic, international
        dsaRateStore.createIndex("dailyRate", "dailyRate", { unique: false });
        dsaRateStore.createIndex("accommodationRate", "accommodationRate", {
          unique: false,
        });
        dsaRateStore.createIndex("effectiveFrom", "effectiveFrom", {
          unique: false,
        });
        dsaRateStore.createIndex("effectiveTo", "effectiveTo", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("dsaPayments")) {
        ...
        dsaPayStore.createIndex("paymentNumber", "paymentNumber", {
          unique: true,
        });
        dsaPayStore.createIndex("travelRequestId", "travelRequestId", {
          unique: false,
        });
        dsaPayStore.createIndex("employeeId", "employeeId", { unique: false });
        dsaPayStore.createIndex("numberOfDays", "numberOfDays", {
          unique: false,
        });
        dsaPayStore.createIndex("dailyRate", "dailyRate", { unique: false });
        dsaPayStore.createIndex("totalAmount", "totalAmount", {
          unique: false,
        });
        dsaPayStore.createIndex("advanceAmount", "advanceAmount", {
          unique: false,
        });
        dsaPayStore.createIndex("settlementAmount", "settlementAmount", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("workRelatedInjuries")) {
        ...
        injuryStore.createIndex("incidentNumber", "incidentNumber", {
          unique: true,
        });
        injuryStore.createIndex("employeeId", "employeeId", { unique: false });
        injuryStore.createIndex("incidentDate", "incidentDate", {
          unique: false,
        });
        injuryStore.createIndex("incidentLocation", "incidentLocation", {
          unique: false,
        }); // office, travel, field
        injuryStore.createIndex("injuryType", "injuryType", { unique: false });
        injuryStore.createIndex("reportedDate", "reportedDate", {
          unique: false,
        });
        injuryStore.createIndex("status", "status", { unique: false }); // reported, investigating, approved, rejected, settled
        injuryStore.createIndex("claimAmount", "claimAmount", {
          unique: false,
        });
        injuryStore.createIndex("approvedAmount", "approvedAmount", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("staffAssociationPositions")) {
        const assocPosStore = db.createObjectStore(
        ...
        assocPosStore.createIndex("isExecutive", "isExecutive", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("staffAssociationMembers")) {
        ...
        assocMemStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        assocMemStore.createIndex("positionId", "positionId", {
          unique: false,
        });
        ...
        assocMemStore.createIndex("electionDate", "electionDate", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("associationMeetings")) {
        ...
        meetingStore.createIndex("meetingNumber", "meetingNumber", {
          unique: true,
        });
        meetingStore.createIndex("meetingType", "meetingType", {
          unique: false,
        }); // regular, agm, special
        meetingStore.createIndex("meetingDate", "meetingDate", {
          unique: false,
        });
        meetingStore.createIndex("status", "status", { unique: false }); // scheduled, completed, cancelled
        meetingStore.createIndex("attendeeCount", "attendeeCount", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("associationActivities")) {
        ...
        activityStore.createIndex("activityType", "activityType", {
          unique: false,
        }); // social_event, team_building, welfare, training
        activityStore.createIndex("activityDate", "activityDate", {
          unique: false,
        });
        activityStore.createIndex("organizedBy", "organizedBy", {
          unique: false,
        });
        activityStore.createIndex("status", "status", { unique: false });
        activityStore.createIndex("budget", "budget", { unique: false });
        activityStore.createIndex("participantCount", "participantCount", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("staffAssociationContributions")) {
        const contribStore = db.createObjectStore(
        ...
        contribStore.createIndex("paymentDate", "paymentDate", {
          unique: false,
        });
        contribStore.createIndex("paymentMethod", "paymentMethod", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("staffWelfareRequests")) {
        ...
        welfareReqStore.createIndex("memberName", "memberName", {
          unique: false,
        });
        welfareReqStore.createIndex("requestType", "requestType", {
          unique: false,
        }); // medical, death, marriage, childbirth, disaster, education, emergency
        welfareReqStore.createIndex("amountRequested", "amountRequested", {
          unique: false,
        });
        welfareReqStore.createIndex("amountApproved", "amountApproved", {
          unique: false,
        });
        welfareReqStore.createIndex("requestDate", "requestDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("staffWelfarePayments")) {
        ...
        welfarePayStore.createIndex("memberName", "memberName", {
          unique: false,
        });
        welfarePayStore.createIndex("requestId", "requestId", {
          unique: false,
        });
        welfarePayStore.createIndex("requestReference", "requestReference", {
          unique: false,
        });
        welfarePayStore.createIndex("amountPaid", "amountPaid", {
          unique: false,
        });
        welfarePayStore.createIndex("paymentDate", "paymentDate", {
          unique: false,
        });
        welfarePayStore.createIndex("paymentMethod", "paymentMethod", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("policyVersions")) {
        ...
        policyStore.createIndex("effectiveDate", "effectiveDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("projects")) {
        ...
        projectStore.createIndex("projectCode", "projectCode", {
          unique: true,
        });
      ...
      if (!db.objectStoreNames.contains("bankAccounts")) {
        ...
        bankAccountStore.createIndex("accountNumber", "accountNumber", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("bankSignatories")) {
        ...
        signatoryStore.createIndex("bankAccountId", "bankAccountId", {
          unique: false,
        });
        signatoryStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        signatoryStore.createIndex("signatoryType", "signatoryType", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("budgetCategories")) {
        ...
        budgetCatStore.createIndex("categoryName", "categoryName", {
          unique: false,
        });
        budgetCatStore.createIndex("categoryCode", "categoryCode", {
          unique: true,
        });
      ...
      if (!db.objectStoreNames.contains("projectBudgets")) {
        ...
        projBudgetStore.createIndex("projectId", "projectId", {
          unique: false,
        });
        projBudgetStore.createIndex("budgetCategoryId", "budgetCategoryId", {
          unique: false,
        });
        projBudgetStore.createIndex("fiscalYear", "fiscalYear", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("budgetExpenditures")) {
        ...
        expenditureStore.createIndex("projectBudgetId", "projectBudgetId", {
          unique: false,
        });
        expenditureStore.createIndex("expenditureDate", "expenditureDate", {
          unique: false,
        });
        expenditureStore.createIndex("createdBy", "createdBy", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("projectStaffCosts")) {
        ...
        staffCostStore.createIndex("employeeId", "employeeId", {
          unique: false,
        });
        staffCostStore.createIndex("amendmentNumber", "amendmentNumber", {
          unique: false,
        });
        staffCostStore.createIndex("gradeLevel", "gradeLevel", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("projectOperationalCosts")) {
        ...
        opsCostStore.createIndex("costCategory", "costCategory", {
          unique: false,
        });
        opsCostStore.createIndex("amendmentNumber", "amendmentNumber", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("cashRequests")) {
        ...
        cashReqStore.createIndex("requestNumber", "requestNumber", {
          unique: true,
        });
        cashReqStore.createIndex("requestMonth", "requestMonth", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("cashRequestItems")) {
        ...
        cashItemStore.createIndex("cashRequestId", "cashRequestId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("installmentRequests")) {
        ...
        instReqStore.createIndex("dateRequested", "dateRequested", {
          unique: false,
        });
        instReqStore.createIndex("amendmentNumber", "amendmentNumber", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("installmentReceipts")) {
        ...
        instReceiptStore.createIndex(
          "installmentRequestId",
          "installmentRequestId",
          { unique: false }
        );
        instReceiptStore.createIndex("receiptDate", "receiptDate", {
          unique: false,
        });
        instReceiptStore.createIndex("bankAccountId", "bankAccountId", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("staffSalaryAllocations")) {
        ...
        allocStore.createIndex("allocationMonth", "allocationMonth", {
          unique: false,
        });
      }

      // Payroll Distributions store - for project-wise salary distribution
      if (!db.objectStoreNames.contains("payrollDistributions")) {
        const distStore = db.createObjectStore("payrollDistributions", {
          keyPath: "id",
          autoIncrement: true,
        });
        distStore.createIndex("payrollPeriodId", "payrollPeriodId", {
          unique: false,
        });
        distStore.createIndex("employeeId", "employeeId", { unique: false });
        distStore.createIndex("generationType", "generationType", {
          unique: false,
        });
        distStore.createIndex("status", "status", { unique: false });
        distStore.createIndex("createdAt", "createdAt", { unique: false });
      }

      // Donor Reporting Schedules store
      if (!db.objectStoreNames.contains("donorReportingSchedules")) {
        const reportScheduleStore = db.createObjectStore(
        ...
        reportScheduleStore.createIndex("projectId", "projectId", {
          unique: false,
        });
        reportScheduleStore.createIndex("dueDate", "dueDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("donorReportPeriods")) {
        ...
        reportPeriodStore.createIndex(
          "reportingScheduleId",
          "reportingScheduleId",
          { unique: false }
        );
        reportPeriodStore.createIndex("status", "status", { unique: false });
        reportPeriodStore.createIndex("submittedBy", "submittedBy", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("governmentReporting")) {
        ...
        govReportStore.createIndex("ministryName", "ministryName", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("projectAmendments")) {
        ...
        amendStore.createIndex("amendmentNumber", "amendmentNumber", {
          unique: false,
        });
        amendStore.createIndex("amendmentDate", "amendmentDate", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("signatoryAssignments")) {
        ...
        sigAssignStore.createIndex("assignmentMonth", "assignmentMonth", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("complianceProjects")) {
        ...
        compProjStore.createIndex("projectName", "projectName", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("registrations")) {
        ...
        regStore.createIndex("organizationPlatform", "organizationPlatform", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("memberships")) {
        ...
        memberStore.createIndex("platformType", "platformType", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("certificates")) {
        ...
        certStore.createIndex("nameOfInstitution", "nameOfInstitution", {
          unique: false,
        });
        certStore.createIndex("agency", "agency", { unique: false });
        certStore.createIndex("typeOfDocument", "typeOfDocument", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("partners")) {
        ...
        partnerStore.createIndex("namePartner", "namePartner", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("governmentOutreach")) {
        ...
        goStore.createIndex("govtEntityName", "govtEntityName", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("vendors")) {
        ...
        vendorStore.createIndex("companyName", "companyName", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("contracts")) {
        ...
        contractStore.createIndex("contractNumber", "contractNumber", {
          unique: true,
        });
      ...
      if (!db.objectStoreNames.contains("dnrTracking")) {
        ...
        dnrStore.createIndex("projectStatus", "projectStatus", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("mouTracking")) {
        ...
        mouStore.createIndex("sectoralAuthority", "sectoralAuthority", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("inOutTracking")) {
        ...
        inOutStore.createIndex("documentType", "documentType", {
          unique: false,
        });
        inOutStore.createIndex("referenceNumber", "referenceNumber", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("accessTracking")) {
        ...
        accessStore.createIndex("projectName", "projectName", {
          unique: false,
        });
        accessStore.createIndex("lineMinistry", "lineMinistry", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("recruitments")) {
        ...
        recruitmentStore.createIndex("recruitmentCode", "recruitmentCode", {
          unique: true,
        });
        recruitmentStore.createIndex("status", "status", { unique: false });
        recruitmentStore.createIndex("currentStep", "currentStep", {
          unique: false,
        });
        recruitmentStore.createIndex("hiringApproach", "hiringApproach", {
          unique: false,
        });
        recruitmentStore.createIndex("createdBy", "createdBy", {
          unique: false,
        });
        recruitmentStore.createIndex("createdAt", "createdAt", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("termsOfReferences")) {
        ...
        torStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        torStore.createIndex("positionTitle", "positionTitle", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("staffRequisitions")) {
        ...
        srfStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("vacancyAnnouncements")) {
        ...
        vacancyStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        vacancyStore.createIndex("announcementMethod", "announcementMethod", {
          unique: false,
        });
        vacancyStore.createIndex("status", "status", { unique: false });
        vacancyStore.createIndex("closingDate", "closingDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("candidateApplications")) {
        ...
        appStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        appStore.createIndex("applicationCode", "applicationCode", {
          unique: true,
        });
        appStore.createIndex("applicationMethod", "applicationMethod", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("candidateExperiences")) {
        ...
        expStore.createIndex("organizationName", "organizationName", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("recruitmentCommittees")) {
        ...
        commStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("committeeMembers")) {
        ...
        memberStore.createIndex("committeeId", "committeeId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("coiDeclarations")) {
        ...
        coiStore.createIndex("committeeMemberId", "committeeMemberId", {
          unique: false,
        });
        coiStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("longlistings")) {
        ...
        llStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("longlistingCandidates")) {
        ...
        llcStore.createIndex("longlistingId", "longlistingId", {
          unique: false,
        });
        llcStore.createIndex(
      ...
      if (!db.objectStoreNames.contains("shortlistings")) {
        ...
        slStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("shortlistingCandidates")) {
        ...
        slcStore.createIndex("shortlistingId", "shortlistingId", {
          unique: false,
        });
        slcStore.createIndex(
          "candidateApplicationId",
          "candidateApplicationId",
          { unique: false }
        );
        slcStore.createIndex("isShortlisted", "isShortlisted", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("writtenTests")) {
        ...
        wtStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("writtenTestCandidates")) {
        ...
        wtcStore.createIndex("writtenTestId", "writtenTestId", {
          unique: false,
        });
        wtcStore.createIndex(
          "candidateApplicationId",
          "candidateApplicationId",
          { unique: false }
        );
      ...
      if (!db.objectStoreNames.contains("recruitmentInterviews")) {
        ...
        intStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        intStore.createIndex("interviewDate", "interviewDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("recruitmentInterviewEvaluations")) {
        const ieStore = db.createObjectStore(
          "recruitmentInterviewEvaluations",
          {
            keyPath: "id",
            autoIncrement: true,
        ...
        ieStore.createIndex("interviewCandidateId", "interviewCandidateId", {
          unique: false,
        });
        ieStore.createIndex("evaluatorId", "evaluatorId", { unique: false });
        ieStore.createIndex("recommendation", "recommendation", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("recruitmentInterviewResults")) {
        ...
        irStore.createIndex("interviewCandidateId", "interviewCandidateId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("recruitmentReports")) {
        ...
        rrStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("offerLetters")) {
        ...
        olStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        olStore.createIndex(
          "candidateApplicationId",
      ...
      if (!db.objectStoreNames.contains("sanctionClearances")) {
        ...
        scStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        scStore.createIndex(
          "candidateApplicationId",
      ...
      if (!db.objectStoreNames.contains("backgroundChecks")) {
        ...
        bcStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        bcStore.createIndex(
          "candidateApplicationId",
        ...
        bcStore.createIndex("overallStatus", "overallStatus", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("referenceChecks")) {
        ...
        refStore.createIndex("backgroundCheckId", "backgroundCheckId", {
          unique: false,
        });
        refStore.createIndex("referenceName", "referenceName", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("guaranteeLetters")) {
        ...
        glStore.createIndex("backgroundCheckId", "backgroundCheckId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("homeAddressVerifications")) {
        ...
        havStore.createIndex("backgroundCheckId", "backgroundCheckId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("criminalChecks")) {
        ...
        cbcStore.createIndex("backgroundCheckId", "backgroundCheckId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("employmentContracts")) {
        ...
        ecStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
        ecStore.createIndex(
          "candidateApplicationId",
        ...
        ecStore.createIndex("contractNumber", "contractNumber", {
          unique: true,
        });
      ...
      if (!db.objectStoreNames.contains("fileChecklists")) {
        ...
        fcStore.createIndex("recruitmentId", "recruitmentId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingPrograms")) {
        ...
        tpStore.createIndex("trainingTypeId", "trainingTypeId", {
          unique: false,
        });
        tpStore.createIndex("deliveryMethod", "deliveryMethod", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingNeedsAssessments")) {
        ...
        tnaStore.createIndex("assessmentNumber", "assessmentNumber", {
          unique: true,
        });
        tnaStore.createIndex("employeeId", "employeeId", { unique: false });
        tnaStore.createIndex("assessorId", "assessorId", { unique: false });
        tnaStore.createIndex("assessmentPeriod", "assessmentPeriod", {
          unique: false,
        });
        tnaStore.createIndex("status", "status", { unique: false });
        tnaStore.createIndex("trainingLevel", "trainingLevel", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("tnaTrainingNeeds")) {
        ...
        ttnStore.createIndex("trainingTypeId", "trainingTypeId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingCalendar")) {
        ...
        tcStore.createIndex("trainingProgramId", "trainingProgramId", {
          unique: false,
        });
        tcStore.createIndex("plannedStartDate", "plannedStartDate", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingBudgetProposals")) {
        ...
        tbpStore.createIndex("proposalNumber", "proposalNumber", {
          unique: true,
        });
        tbpStore.createIndex("trainingProgramId", "trainingProgramId", {
          unique: false,
        });
        tbpStore.createIndex("departmentId", "departmentId", { unique: false });
        tbpStore.createIndex("status", "status", { unique: false });
        tbpStore.createIndex("fundingSource", "fundingSource", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("trainings")) {
        ...
        trStore.createIndex("trainingProgramId", "trainingProgramId", {
          unique: false,
        });
        trStore.createIndex("calendarId", "calendarId", { unique: false });
        trStore.createIndex("budgetProposalId", "budgetProposalId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingParticipants")) {
        ...
        tprtStore.createIndex("invitationStatus", "invitationStatus", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("trainingSessionAttendance")) {
        ...
        tsaStore.createIndex("participantId", "participantId", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("trainingEvaluations")) {
        ...
        teStore.createIndex("participantId", "participantId", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("trainingCertificates")) {
        ...
        tcertStore.createIndex("certificateNumber", "certificateNumber", {
          unique: true,
        });
      ...
      if (!db.objectStoreNames.contains("employeeTrainingHistory")) {
        ...
        ethStore.createIndex("trainingTypeId", "trainingTypeId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("clearanceItems")) {
        ...
        ciStore.createIndex("returnCondition", "returnCondition", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("exitComplianceChecks")) {
        ...
        eccStore.createIndex("exitInterviewId", "exitInterviewId", {
          unique: false,
        });
        eccStore.createIndex("checkArea", "checkArea", { unique: false });
        eccStore.createIndex("requiresFollowup", "requiresFollowup", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("exitInterviewSummaries")) {
        ...
        eisStore.createIndex("exitInterviewId", "exitInterviewId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("settlementPayments")) {
        ...
        spStore.createIndex("paymentReference", "paymentReference", {
          unique: true,
        });
        spStore.createIndex("paymentDate", "paymentDate", { unique: false });
        spStore.createIndex("paymentMethod", "paymentMethod", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("terminationRecords")) {
        ...
        trStore.createIndex("terminationType", "terminationType", {
          unique: false,
        });
        trStore.createIndex("causeCategory", "causeCategory", {
          unique: false,
        });
        trStore.createIndex("terminationDate", "terminationDate", {
          unique: false,
        });
        trStore.createIndex("appealAllowed", "appealAllowed", {
          unique: false,
        });
        trStore.createIndex("appealOutcome", "appealOutcome", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("handoverRecords")) {
        ...
        hrStore.createIndex("handoverToEmployeeId", "handoverToEmployeeId", {
          unique: false,
        });
        hrStore.createIndex("status", "status", { unique: false });
        hrStore.createIndex("supervisorVerified", "supervisorVerified", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("handoverItems")) {
        ...
        hiStore.createIndex("handoverStatus", "handoverStatus", {
          unique: false,
        });
      }
      ...
      if (!db.objectStoreNames.contains("leavePolicies")) {
        ...
        policyStore.createIndex("leaveTypeId", "leaveTypeId", {
          unique: false,
        });
        policyStore.createIndex("employeeType", "employeeType", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("employeeLeaveBalances")) {
        ...
        balanceStore.createIndex("leaveTypeId", "leaveTypeId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("holidays")) {
        ...
        holidayStore.createIndex("holidayType", "holidayType", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("leaveRequestDays")) {
        ...
        lrdStore.createIndex("leaveRequestId", "leaveRequestId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("oicAssignments")) {
        ...
        oicStore.createIndex("leaveRequestId", "leaveRequestId", {
          unique: false,
        });
        oicStore.createIndex("absentEmployeeId", "absentEmployeeId", {
          unique: false,
        });
        oicStore.createIndex("oicEmployeeId", "oicEmployeeId", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains("leaveAdjustments")) {
        ...
        adjStore.createIndex("adjustmentType", "adjustmentType", {
          unique: false,
        });
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalCycles)) {
        const store = db.createObjectStore(APPRAISAL_STORES.appraisalCycles, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalTemplates)) {
        const store = db.createObjectStore(
          APPRAISAL_STORES.appraisalTemplates,
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalSections)) {
        const store = db.createObjectStore(APPRAISAL_STORES.appraisalSections, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalCriteria)) {
        const store = db.createObjectStore(APPRAISAL_STORES.appraisalCriteria, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.employeeAppraisals)) {
        const store = db.createObjectStore(
          APPRAISAL_STORES.employeeAppraisals,
          { keyPath: "id", autoIncrement: true }
        );
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalRatings)) {
        const store = db.createObjectStore(APPRAISAL_STORES.appraisalRatings, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (
        !db.objectStoreNames.contains(
          APPRAISAL_STORES.appraisalCommitteeMembers
        )
      ) {
        const store = db.createObjectStore(
          APPRAISAL_STORES.appraisalCommitteeMembers,
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalGoals)) {
        const store = db.createObjectStore(APPRAISAL_STORES.appraisalGoals, {
          keyPath: "id",
          autoIncrement: true,
        });
        store.createIndex("by_appraisal", "appraisalId");
      ...
      if (
        !db.objectStoreNames.contains(APPRAISAL_STORES.appraisalTrainingNeeds)
      ) {
        const store = db.createObjectStore(
          APPRAISAL_STORES.appraisalTrainingNeeds,
          { keyPath: "id", autoIncrement: true }
        );
        store.createIndex("by_appraisal", "appraisalId");
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.probationRecords)) {
        const store = db.createObjectStore(APPRAISAL_STORES.probationRecords, {
          keyPath: "id",
          autoIncrement: true,
        });
        store.createIndex("by_employee", "employeeId");
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.probationExtensions)) {
        const store = db.createObjectStore(
          APPRAISAL_STORES.probationExtensions,
          { keyPath: "id", autoIncrement: true }
        );
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.probationKpis)) {
        const store = db.createObjectStore(APPRAISAL_STORES.probationKpis, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (
        !db.objectStoreNames.contains(
          APPRAISAL_STORES.performanceImprovementPlans
        )
      ) {
        const store = db.createObjectStore(
          APPRAISAL_STORES.performanceImprovementPlans,
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.pipGoals)) {
        const store = db.createObjectStore(APPRAISAL_STORES.pipGoals, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.pipCheckIns)) {
        const store = db.createObjectStore(APPRAISAL_STORES.pipCheckIns, {
          keyPath: "id",
          autoIncrement: true,
        });
        store.createIndex("by_pip", "pipId");
      ...
      if (!db.objectStoreNames.contains(APPRAISAL_STORES.appraisalOutcomes)) {
        const store = db.createObjectStore(APPRAISAL_STORES.appraisalOutcomes, {
          keyPath: "id",
          autoIncrement: true,
        });
        store.createIndex("by_appraisal", "appraisalId");
      ...
      if (!db.objectStoreNames.contains("employeeAllowances")) {
        ...
        store.createIndex("employeeId", "employeeId", { unique: false });
        store.createIndex("salaryComponentId", "salaryComponentId", {
          unique: false,
        });
        store.createIndex("isActive", "isActive", { unique: false });
      }
      ...
      if (!db.objectStoreNames.contains("payrollEntries")) {
        ...
        store.createIndex("payrollPeriodId", "payrollPeriodId", {
          unique: false,
        });
        store.createIndex("employeeId", "employeeId", { unique: false });
        store.createIndex("status", "status", { unique: false });
      ...
      if (!db.objectStoreNames.contains("advanceRepayments")) {
        ...
        store.createIndex("payrollEntryId", "payrollEntryId", {
          unique: false,
        });
      }
...
export const employeeDB = {
  ...
  getStatistics: async () => {
    ...
    return {
      ...
      newThisMonth: employees.filter(
        (e) => new Date(e.createdAt) >= firstOfMonth
      ).length,
...
// Employee Position History operations - tracks employment history (positions, projects, periods)
export const employeePositionHistoryDB = {
  // Create a new position record for an employee
  create: async (historyData) => {
    ...
    const id = await db.add("employeePositionHistory", record);
    return { ...record, id };
  },

  // Get all position history for an employee
  getByEmployeeId: async (employeeId) => {
    const db = await getDB();
    const tx = db.transaction("employeePositionHistory", "readonly");
    const index = tx.store.index("employeeId");
    const records = await index.getAll(Number(employeeId));
  ...
  getById: async (id) => {
    const db = await getDB();
    return db.get("employeePositionHistory", Number(id));
  },

  // Get current position for an employee
  getCurrentPosition: async (employeeId) => {
    const db = await getDB();
    const tx = db.transaction("employeePositionHistory", "readonly");
    const index = tx.store.index("employeeId");
    const records = await index.getAll(Number(employeeId));
    return records.find((r) => r.isCurrent === true) || null;
  },

  // Update a position record
  update: async (id, historyData) => {
    const db = await getDB();
    const existing = await db.get("employeePositionHistory", Number(id));

    if (!existing) {
      throw new Error("Position history record not found");
    }
    ...
    await db.put("employeePositionHistory", updated);
    return updated;
  },

  // End a current position (set end date and isCurrent to false)
  endPosition: async (id, endDate, reason = "") => {
    const db = await getDB();
    const existing = await db.get("employeePositionHistory", Number(id));
  ...
  // Add new position and end previous current position
  addNewPosition: async (employeeId, newPositionData) => {
    const db = await getDB();
    const now = new Date().toISOString();

    // Find and end current position if exists
    const tx = db.transaction("employeePositionHistory", "readonly");
    const index = tx.store.index("employeeId");
    const records = await index.getAll(Number(employeeId));
    const currentPosition = records.find((r) => r.isCurrent === true);

    if (currentPosition) {
      // End the current position
      await employeePositionHistoryDB.endPosition(
        currentPosition.id,
        newPositionData.startDate || now.split("T")[0],
        "Position change"
      );
    }
    ...
    const id = await db.add("employeePositionHistory", newRecord);
    return { ...newRecord, id };
  },
  ...
  delete: async (id) => {
    const db = await getDB();
    await db.delete("employeePositionHistory", Number(id));
    return true;
  },

  // Get all position history records
  getAll: async () => {
    const db = await getDB();
    return db.getAll("employeePositionHistory");
  },
};
  ...
  seedDefaults: async () => {
    ...
    if (existing.length === 0) {
      const defaults = [
        ...
        {
          name: "Branch Office - Herat",
          city: "Herat",
          country: "Afghanistan",
          address: "Central Road, Herat",
        },
        {
          name: "Branch Office - Mazar",
          city: "Mazar-i-Sharif",
          country: "Afghanistan",
          address: "Business District, Mazar",
        },
      ];
...
export const documentTypeDB = {
  ...
  seedDefaults: async () => {
    ...
    if (existing.length === 0) {
      const defaults = [
        {
          name: "National ID / Tazkira",
          code: "NID",
          required: true,
          description: "National identification card or Tazkira",
        },
        {
          name: "Passport",
          code: "PAS",
        ...
        },
        {
          ...
          code: "EDU",
          required: true,
          description: "Educational degree or certificate",
        },
        {
    ...
    if (existing.length === 0) {
      const defaults = [
        ...
        },
        {
          ...
          icon: "Armchair",
          active: true,
          description: "Office and building furniture",
        },
        {
          name: "Vehicles",
          code: "VEH",
        ...
        },
        {
          ...
          icon: "Heart",
          active: true,
          description: "Medical and health supplies",
        },
        {
        ...
        // Office Supplies Subcategories
        {
          ...
          icon: "Pen",
          active: true,
          description: "Pens, pencils, paper, notebooks",
        },
        {
          name: "Filing & Storage",
          code: "FIL",
          ...
          icon: "FolderOpen",
          active: true,
          description: "Files, folders, storage boxes",
        },
        {
        ...
        },
        {
          ...
          icon: "Table",
          active: true,
          description: "Meeting tables and chairs",
        },
...
export const purchaseRequestDB = {
  create: async (data) => {
    ...
    if (!data.prNumber) {
      ...
      const year = new Date().getFullYear();
      const nextNumber =
        allPRs.filter((pr) => pr.prNumber?.startsWith(`PR-${year}`)).length + 1;
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.requestedBy) {
      requests = requests.filter(
        (pr) => pr.requestedBy === filters.requestedBy
      );
    }
    ...
    const defaults = [
      {
        ...
        description:
          "Replenishment of essential office supplies including paper, pens, and folders",
        ...
        items: [
          ...
          },
          {
            ...
            category: categories.find((c) => c.name === "Writing Instruments")
              ?.id,
        ...
        items: [
          {
            ...
            specifications:
              'Intel Core i7-1365U, 16GB DDR4, 512GB NVMe SSD, 15.6" FHD',
            estimatedTotal: 6000,
          },
          {
        ...
        items: [
          {
            ...
            category: categories.find((c) => c.name === "Cleaning Supplies")
              ?.id,
...
export const purchaseOrderDB = {
  create: async (data) => {
    ...
    if (!data.poNumber) {
      ...
      const year = new Date().getFullYear();
      const nextNumber =
        allPOs.filter((po) => po.poNumber?.startsWith(`PO-${year}`)).length + 1;
  ...
  seedDefaults: async () => {
    ...
    const defaults = [
      ...
      },
      {
        ...
        prNumber: "PR-2024-0002",
        vendorId:
          vendors.find((v) => v.companyName.includes("Tech"))?.id ||
          vendors[1]?.id,
        ...
        status: "In Transit",
        notes:
          "Fragile - handle with care. Include original packaging and warranty cards.",
        createdAt: new Date("2024-11-12").toISOString(),
      ...
      },
      {
        ...
        prNumber: "PR-2024-0004",
        vendorId:
          vendors.find((v) => v.companyName.includes("Furniture"))?.id ||
          vendors[2]?.id,
      ...
      },
      {
        ...
        prNumber: "",
        vendorId:
          vendors.find((v) => v.companyName.includes("Supplies"))?.id ||
          vendors[0]?.id,
...
export const goodsReceiptDB = {
  create: async (data) => {
    ...
    if (!data.grNumber) {
      ...
      const year = new Date().getFullYear();
      const nextNumber =
        allGRs.filter((gr) => gr.grNumber?.startsWith(`GR-${year}`)).length + 1;
...
export const inventoryItemDB = {
  ...
  update: async (id, data) => {
    ...
    const updated = {
      ...
      id,
      quantityAvailable:
        (data.quantityOnHand || existing.quantityOnHand) -
        (data.quantityReserved || existing.quantityReserved || 0),
      updatedAt: new Date().toISOString(),
    };
...
export const contractDB = {
  create: async (data) => {
    ...
    if (!data.contractNumber) {
      ...
      const year = new Date().getFullYear();
      const nextNumber =
        allContracts.filter((c) => c.contractNumber?.startsWith(`CON-${year}`))
          .length + 1;
      data.contractNumber = `CON-${year}-${String(nextNumber).padStart(
        4,
        "0"
      )}`;
    }
...
export const rolePermissionDB = {
  assign: async (roleId, permissionId) => {
    ...
    const found = existing.find(
      (rp) =>
        rp.roleId === Number(roleId) && rp.permissionId === Number(permissionId)
    );
    if (found) {
      return found;
    }
...
export const attendanceDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.employeeId) {
      records = records.filter(
        (r) => r.employeeId === Number(filters.employeeId)
      );
    }
...
export const leaveRequestDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.leaveTypeId) {
      requests = requests.filter(
        (r) => r.leaveTypeId === Number(filters.leaveTypeId)
      );
    }
    ...
    if (filters.startDate && filters.endDate) {
      requests = requests.filter(
        (r) => r.startDate >= filters.startDate && r.endDate <= filters.endDate
      );
    }
...
export const jobRequisitionDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.department) {
      requisitions = requisitions.filter(
        (r) => r.department === filters.department
      );
    }
...
export const candidateDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.requisitionId) {
      candidates = candidates.filter(
        (c) => c.requisitionId === Number(filters.requisitionId)
      );
    }
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.candidateId) {
      interviews = interviews.filter(
        (i) => i.candidateId === Number(filters.candidateId)
      );
    }

    if (filters.requisitionId) {
      interviews = interviews.filter(
        (i) => i.requisitionId === Number(filters.requisitionId)
      );
    }

    if (filters.interviewerId) {
      interviews = interviews.filter(
        (i) => i.interviewerId === Number(filters.interviewerId)
      );
    }
    ...
    if (filters.date) {
      interviews = interviews.filter((i) =>
        i.scheduledDate?.startsWith(filters.date)
      );
    }
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.candidateId) {
      offers = offers.filter(
        (o) => o.candidateId === Number(filters.candidateId)
      );
    }

    if (filters.requisitionId) {
      offers = offers.filter(
        (o) => o.requisitionId === Number(filters.requisitionId)
      );
    }
...
export const jobAnnouncementDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.requisitionId) {
      announcements = announcements.filter(
        (a) => a.requisitionId === Number(filters.requisitionId)
      );
    }
  ...
  getByRequisition: async (requisitionId) => {
    const db = await getDB();
    const index = db
      .transaction("jobAnnouncements")
      .store.index("requisitionId");
    return index.getAll(Number(requisitionId));
  },
...
export const payrollDB = {
  ...
  calculateSalary: (employee, components) => {
    ...
    for (const comp of components.filter(
      (c) => c.type === "allowance" && c.status === "active"
    )) {
      const amount =
    ...
    for (const comp of components.filter(
      (c) => c.type === "deduction" && c.status === "active"
    )) {
      const amount =
        comp.calculationType === "percentage"
      ...
      const defaults = [
        {
          ...
          contactEmail: "john@unicef.org",
        },
        {
          name: "World Food Programme",
          code: "WFP",
          contactPerson: "Jane Doe",
          contactEmail: "jane@wfp.org",
        },
        {
          name: "UN Women",
          code: "UNW",
          contactPerson: "Mary Johnson",
          contactEmail: "mary@unwomen.org",
        },
      ];
    ...
    const defaultProjects = [
      {
        ...
        status: "ongoing",
        description:
          "Supporting smallholder farmers with agricultural inputs and training",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
      ...
      },
      {
        ...
        status: "ongoing",
        description:
          "Installing solar power systems in off-grid rural communities",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ];
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.bankAccountId) {
      signatories = signatories.filter(
        (s) => s.bankAccountId === Number(filters.bankAccountId)
      );
    }
  ...
  seedDefaults: async () => {
    ...
    if (existing.length === 0) {
      const defaults = [
        ...
        {
          categoryName: "Equipment and Supplies",
          categoryCode: "EQUIP",
          description: "Equipment and office supplies",
        },
        {
          categoryName: "Training and Workshops",
          categoryCode: "TRAIN",
          description: "Training and workshop expenses",
        },
        {
        ...
        {
          categoryName: "Monitoring and Evaluation",
          categoryCode: "ME",
          description: "M&E activities",
        },
        {
          categoryName: "Administrative Costs",
          categoryCode: "ADMIN",
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.projectId) {
      budgets = budgets.filter(
        (b) => b.projectId === Number(filters.projectId)
      );
    }
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.projectBudgetId) {
      expenditures = expenditures.filter(
        (e) => e.projectBudgetId === Number(filters.projectBudgetId)
      );
    }
    ...
    if (filters.startDate && filters.endDate) {
      expenditures = expenditures.filter(
        (e) =>
          e.expenditureDate >= filters.startDate &&
          e.expenditureDate <= filters.endDate
      );
    }

    expenditures.sort(
      (a, b) => new Date(b.expenditureDate) - new Date(a.expenditureDate)
    );
    return expenditures;
  },
...
export const projectStaffCostDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.amendmentNumber !== undefined) {
      costs = costs.filter(
        (c) => c.amendmentNumber === filters.amendmentNumber
      );
    }
...
export const cashRequestDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.requestMonth) {
      requests = requests.filter(
        (r) => r.requestMonth === filters.requestMonth
      );
    }
...
export const cashRequestItemDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.cashRequestId) {
      items = items.filter(
        (i) => i.cashRequestId === Number(filters.cashRequestId)
      );
    }
...
export const installmentRequestDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.projectId) {
      requests = requests.filter(
        (r) => r.projectId === Number(filters.projectId)
      );
    }
...
export const installmentReceiptDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.installmentRequestId) {
      receipts = receipts.filter(
        (r) => r.installmentRequestId === Number(filters.installmentRequestId)
      );
    }
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.employeeId) {
      allocations = allocations.filter(
        (a) => a.employeeId === Number(filters.employeeId)
      );
    }

    if (filters.projectId) {
      allocations = allocations.filter(
        (a) => a.projectId === Number(filters.projectId)
      );
    }

    if (filters.allocationMonth) {
      allocations = allocations.filter(
        (a) => a.allocationMonth === filters.allocationMonth
      );
    }
...
// Payroll Distribution operations (project-wise salary distribution)
export const payrollDistributionDB = {
  create: async (data) => {
    ...
    const id = await db.add("payrollDistributions", distribution);
    return { ...distribution, id };
  },

  getAll: async (filters = {}) => {
    const db = await getDB();
    let distributions = await db.getAll("payrollDistributions");

    if (filters.payrollPeriodId) {
      distributions = distributions.filter(
        (d) => d.payrollPeriodId === Number(filters.payrollPeriodId)
      );
    }

    if (filters.employeeId) {
      distributions = distributions.filter(
        (d) => d.employeeId === Number(filters.employeeId)
      );
    }

    if (filters.generationType) {
      distributions = distributions.filter(
        (d) => d.generationType === filters.generationType
      );
    }
    ...
    distributions.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
    return distributions;
  },

  getById: async (id) => {
    const db = await getDB();
    return db.get("payrollDistributions", Number(id));
  },

  getByPeriod: async (payrollPeriodId) => {
    const db = await getDB();
    const distributions = await db.getAllFromIndex(
  ...
  update: async (id, data) => {
    const db = await getDB();
    const existing = await db.get("payrollDistributions", Number(id));
    if (!existing) throw new Error("Payroll distribution not found");
    const updated = {
      ...existing,
      ...data,
      id: Number(id),
    ...
    await db.put("payrollDistributions", updated);
    return updated;
  },

  delete: async (id) => {
    const db = await getDB();
    await db.delete("payrollDistributions", Number(id));
    return true;
  },
  ...
  bulkCreate: async (items) => {
    ...
    for (const item of items) {
      ...
      const id = await db.add("payrollDistributions", distribution);
      results.push({ ...distribution, id });
    }
    return results;
  },

  deleteByPeriod: async (payrollPeriodId) => {
    const db = await getDB();
    const distributions = await db.getAllFromIndex(
      "payrollDistributions",
      "payrollPeriodId",
    ...
    for (const dist of distributions) {
      await db.delete("payrollDistributions", dist.id);
    }
    return true;
  },

  getSummaryByProject: async (payrollPeriodId) => {
    const db = await getDB();
    const distributions = await db.getAllFromIndex(
      "payrollDistributions",
      "payrollPeriodId",
    ...
    distributions.forEach((dist) => {
      ...
      if (dist.distributions && Array.isArray(dist.distributions)) {
        dist.distributions.forEach((alloc) => {
          if (alloc.isCompanyCharge) {
            companyTotal += alloc.amount || 0;
          } else if (alloc.projectId) {
            if (!projectSummary[alloc.projectId]) {
              projectSummary[alloc.projectId] = {
            ...
            projectSummary[alloc.projectId].totalAmount += alloc.amount || 0;
            projectSummary[alloc.projectId].employeeCount += 1;
          }
        });
      }
    });
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.projectId) {
      schedules = schedules.filter(
        (s) => s.projectId === Number(filters.projectId)
      );
    }
...
export const signatoryAssignmentDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.assignmentMonth) {
      assignments = assignments.filter(
        (a) => a.assignmentMonth === filters.assignmentMonth
      );
    }
    ...
    const defaultProjects = [
      {
        ...
        status: "active",
        description:
          "Improving maternal and child health services in rural areas",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        status: "active",
        description:
          "Increasing enrollment and retention of girls in primary schools",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        status: "active",
        description:
          "Building water wells and sanitation facilities in underserved communities",
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ];
...
export const proposalDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.result)
      proposals = proposals.filter((p) => p.result === filters.result);
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.donorName)
      records = records.filter((r) =>
        r.donorName?.toLowerCase().includes(filters.donorName.toLowerCase())
      );
    return records.sort(
      (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
    );
...
export const registrationDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.status)
      records = records.filter((r) => r.status === filters.status);
    if (filters.organizationPlatform)
      records = records.filter((r) =>
        r.organizationPlatform
          ?.toLowerCase()
          .includes(filters.organizationPlatform.toLowerCase())
      );
    return records.sort(
      (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
    );
...
export const membershipDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.platformType)
      records = records.filter((r) => r.platformType === filters.platformType);
    if (filters.nameMembershipPlatform)
      records = records.filter((r) =>
        r.nameMembershipPlatform
          ?.toLowerCase()
          .includes(filters.nameMembershipPlatform.toLowerCase())
      );
    return records.sort(
      (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
    );
...
export const certificateDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.typeOfDocument)
      records = records.filter(
        (r) => r.typeOfDocument === filters.typeOfDocument
      );
    if (filters.agency)
      records = records.filter((r) => r.agency === filters.agency);
    if (filters.nameOfInstitution)
      records = records.filter((r) =>
        r.nameOfInstitution
          ?.toLowerCase()
          .includes(filters.nameOfInstitution.toLowerCase())
      );
    return records.sort(
      (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
    );
...
export const partnerDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.namePartner)
      partners = partners.filter((p) =>
        p.namePartner?.toLowerCase().includes(filters.namePartner.toLowerCase())
      );
...
export const blacklistDB = {
  ...
  getAll: async (filters = {}) => {
    ...
    if (filters.access)
      records = records.filter((r) => r.access === filters.access);
    if (filters.name)
      records = records.filter((r) =>
...
export const employeeContractDB = {
  ...
  getExpiringContracts: async (daysAhead = 30) => {
    ...
    return contracts.filter(
      (c) => c.status === "active" && new Date(c.endDate) <= futureDate
    );
  },
};
export const contractAmendmentDB = {
  ...
  generateAmendmentNumber: async (contractId) => {
    const db = await getDB();
    const amendments = await db.getAllFromIndex(
      "contractAmendments",
      "contractId",
      contractId
    );
    return `AMD-${contractId}-${String(amendments.length + 1).padStart(
      2,
      "0"
    )}`;
  },
...
export const probationRecordDB = {
  ...
  getEndingProbations: async (daysAhead = 15) => {
    ...
    return records.filter(
      (r) => r.status === "active" && new Date(r.endDate) <= futureDate
    );
  },
};
...
export const sanctionClearanceDB = {
  ...
  getExpiring: async (daysAhead = 30) => {
    ...
    futureDate.setDate(futureDate.getDate() + daysAhead);
    return records.filter(
      (r) => r.result === "cleared" && new Date(r.validUntil) <= futureDate
    );
  },
};
...
export const employeeAllowanceDB = {
  ...
  getActiveAllowances: async (employeeId) => {
    const db = await getDB();
    const allowances = await db.getAllFromIndex(
      "employeeAllowances",
      "employeeId",
      employeeId
    );
...
export const leaveBalanceDB = {
  ...
  getByEmployeeAndYear: async (employeeId, year) => {
    const db = await getDB();
    const balances = await db.getAllFromIndex(
      "leaveBalances",
      "employeeId",
      employeeId
    );
  ...
  calculateBalance: async (employeeId, leaveTypeId, year) => {
    ...
    const balance = balances.find(
      (b) => b.leaveTypeId === leaveTypeId && b.year === year
    );
...
export const ctoRecordDB = {
  ...
  getActiveBalance: async (employeeId) => {
    ...
    const activeRecords = records.filter(
      (r) => r.status !== "expired" && (!r.expiryDate || r.expiryDate >= today)
    );
    return activeRecords.reduce(
      (total, r) => total + (r.hoursEarned - r.hoursUsed),
      0
    );
  },
};
...
export const trainingProgramDB = {
  ...
  getUpcoming: async () => {
    ...
    return programs.filter(
      (p) => p.startDate > today && p.status === "planned"
    );
  },
};
...
export const idCardDB = {
  ...
  getExpiring: async (daysAhead = 30) => {
    ...
    futureDate.setDate(futureDate.getDate() + daysAhead);
    return cards.filter(
      (c) => c.status === "active" && new Date(c.expiryDate) <= futureDate
    );
  },
};
...
export const separationRecordDB = {
  ...
  getPendingSeparations: async () => {
    ...
    return records.filter(
      (r) => r.status === "pending" || r.status === "in_clearance"
    );
  },
};
export const exitClearanceDepartmentDB = createHRModuleCRUD(
  "exitClearanceDepartments"
);
export const exitClearanceDB = {
  ...
  getPendingClearances: async (separationId) => {
    const db = await getDB();
    const clearances = await db.getAllFromIndex(
      "exitClearances",
      "separationId",
      separationId
    );
...
export const travelRequestDB = {
  ...
  getUpcomingTrips: async () => {
    ...
    return requests.filter(
      (r) => r.status === "approved" && r.departureDate > today
    );
  },
};
...
// Staff Association (Chapter 17)
export const staffAssociationPositionDB = createHRModuleCRUD(
  "staffAssociationPositions"
);
export const staffAssociationMemberDB = {
  ...
  getExecutiveCommittee: async () => {
    ...
    const executivePositions = positions
      .filter((p) => p.isExecutive)
      .map((p) => p.id);
    return members.filter(
      (m) => m.status === "active" && executivePositions.includes(m.positionId)
    );
  },
};
export const associationMeetingDB = {
  ...
  getUpcomingMeetings: async () => {
    ...
    return meetings.filter(
      (m) => m.meetingDate >= today && m.status === "scheduled"
    );
  },
};
export const associationActivityDB = {
  ...
  getUpcomingActivities: async () => {
    ...
    return activities.filter(
      (a) => a.activityDate >= today && a.status !== "cancelled"
    );
  },
};
...
export const policyVersionDB = {
  ...
  getActivePolicy: async (policyName) => {
    ...
    return policies.find(
      (p) => p.policyName === policyName && p.status === "active"
    );
  },
};
...
export const seedAllDefaults = async () => {
  try {
    ...
    if (missingStores.length > 0) {
      console.log(
        "Missing stores detected, recreating database:",
        missingStores
      );
      await deleteAndRecreateDB();
    }
