...
const PayrollGenerationReport = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // Since payrollDistributionDB was removed with Finance module,
      // this report now works with data passed via navigation state or URL params
      // For now, show a placeholder message
      setDistribution(null);
      setPeriodDistributions([]);
    } catch (error) {
