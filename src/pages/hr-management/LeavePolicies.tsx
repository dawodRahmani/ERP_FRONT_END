...
import leaveManagementService from "../../services/db/leaveManagementService";
import type {
  LeaveTypeRecord,
  LeavePolicyRecord,
} from "../../types/modules/leave";
import type { EmployeeTypeRecord } from "../../types/modules/coreHR";

const leavePolicyService = leaveManagementService.policies;
...
const LeavePolicies = () => {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      const [policiesData, leaveTypesData, employeeTypesData] =
        await Promise.all([
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = {
        ...
        maxInstancesPerYear: formData.maxInstancesPerYear
          ? Number(formData.maxInstancesPerYear)
          : null,
      };
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Configure leave policies for different leave types and employee
            categories
          </p>
        </div>
        <button
